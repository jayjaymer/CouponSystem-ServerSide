package com.couponsystem.jay.clr.facade;
...
public class CustomerFacadeTEST implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Customer facade TEST
				...
				// ADDING FIRST TIME!
				Coupon purchasedCoupon1 = couponService.getOneCouponByID(2);
				try {
				...
				System.out.println("Amount left = "+purchasedCoupon2.getAmount());
...
//				// adding 2 expired coupons to test daily job thread.
				...
				// Deleting fake coupon with 0 amount
				couponService.deleteCoupon(7);
				...
				couponService.addPurchaseCoupon(2, 10);
